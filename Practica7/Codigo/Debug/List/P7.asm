...
_0x11:
	BLD  R2,1
; 0000 0090 
; 0000 0091 if ((actual == 1) && (pasado == 0)) {
	SBRS R2,1
	RJMP _0x9
	SBRS R2,0
	RJMP _0xA
...
; 0000 0092 unidad++;
	INC  R5
; 0000 0093 delay_ms(40);
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 0094 }
; 0000 0095 
; 0000 0096 if ((actual == 0) && (pasado == 1))
_0x8:
	SBRC R2,1
	RJMP _0xC
	SBRC R2,0
...
; 0000 009F decena = 0;
	CLR  R4
; 0000 00A0 
; 0000 00A1 PORTA = mem[unidad];
_0xF:
	MOV  R30,R5
	RCALL SUBOPT_0x0
	OUT  0x1B,R0
; 0000 00A2 PORTB = mem[decena];
	MOV  R30,R4
	RCALL SUBOPT_0x0
	OUT  0x18,R0
; 0000 00A3 
; 0000 00A4 pasado = actual;
	BST  R2,1
	BLD  R2,0
; 0000 00A5 }
	RJMP _0x3
