...
_0x3:
; 0000 008D {
; 0000 008E contador = 0;
	CLR  R4
	CLR  R5
; 0000 008F 
; 0000 0090 for (i = 0; i < 500; i++) {
	CLR  R6
	CLR  R7
_0x7:
	LDI  R30,LOW(500)
	...
	CPC  R7,R31
	BRGE _0x8
; 0000 0091 if (ENTRADA == 1) contador++;
	SBIS 0x16,0
	RJMP _0x9
	MOVW R30,R4
	ADIW R30,1
...
_0x8:
; 0000 0094 
; 0000 0095 if(contador >= 15 && contador <= 35) {
	LDI  R30,LOW(15)
	LDI  R31,HIGH(15)
	RCALL SUBOPT_0x0
	BRLT _0xB
...
; 0000 0098 PORTA = DER;
	LDI  R30,LOW(1)
	RJMP _0x1B
; 0000 0099 } else if(contador >= 65 && contador <= 85) {
_0xE:
	LDI  R30,LOW(65)
	LDI  R31,HIGH(65)
	RCALL SUBOPT_0x0
...
_0x13:
	RJMP _0x12
_0x14:
; 0000 009A PORTA = ARRIBA;
	LDI  R30,LOW(5)
	RJMP _0x1B
; 0000 009B } else if(contador >= 90 && contador <= 110) {
_0x12:
	LDI  R30,LOW(90)
	LDI  R31,HIGH(90)
	RCALL SUBOPT_0x0
