...
; 0000 0045 DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 0074 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0075 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 0092 // ADC High Speed Mode: Off
...
; 0000 0097 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(129)
	OUT  0x6,R30
; 0000 0098 SFIOR=(1<<ADHSM) | (0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(16)
	OUT  0x30,R30
; 0000 0099 
...
_0x6:
; 0000 00A3 {
; 0000 00A4 valor = read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOV  R5,R30
; 0000 00A5 intensidad = 50 * valor / 255;
	LDI  R26,LOW(50)
	MUL  R30,R26
	MOVW R30,R0
	MOVW R26,R30
	...
	MOV  R4,R30
; 0000 00A6 
; 0000 00A7 delay_ms(7);
	RCALL SUBOPT_0x0
; 0000 00A8 PORTB = ~mem[intensidad/10];
	LDI  R27,0
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL __DIVW21
...
; 0000 00A9 PORTC = 0x01;
	...
	OUT  0x15,R30
; 0000 00AA 
; 0000 00AB delay_ms(7);
	RCALL SUBOPT_0x0
; 0000 00AC PORTB = ~mem[intensidad%10];
	CLR  R27
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL __MODW21
	RCALL SUBOPT_0x1
; 0000 00AD PORTC = 0x02;
	LDI  R30,LOW(2)
	OUT  0x15,R30
; 0000 00AE }
	RJMP _0x6
