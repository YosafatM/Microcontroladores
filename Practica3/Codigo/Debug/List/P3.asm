...
; 0000 002F DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 0030 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0031 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (1<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(255)
	OUT  0x15,R30
; 0000 0032 
...
; 0000 0037 PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0038 
...
_0x3:
; 0000 0087 {
; 0000 0088 num = PIND & 0x0F;
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R5,R30
; 0000 0089 num2 = PINC & 0x0F;
	IN   R30,0x13
	ANDI R30,LOW(0xF)
	MOV  R4,R30
; 0000 008A 
; 0000 008B if (PIND & 0x10) {
	SBIS 0x10,4
	RJMP _0x6
; 0000 008C PORTB = mem[num];
	RCALL SUBOPT_0x0
; 0000 008D PORTA = ~mem[num2];
	RCALL SUBOPT_0x1
	RJMP _0xD
; 0000 008E } else {
_0x6:
...
_0x9:
; 0000 0094 
; 0000 0095 if (num2 < 10) {
	LDI  R30,LOW(10)
	CP   R4,R30
	BRSH _0xA
; 0000 0096 PORTA = ~mem[num2];
	RCALL SUBOPT_0x1
	RJMP _0xD
; 0000 0097 } else {
_0xA:
; 0000 0098 PORTA = ~0x79;
	LDI  R30,LOW(134)
_0xD:
	OUT  0x1B,R30
; 0000 0099 }
