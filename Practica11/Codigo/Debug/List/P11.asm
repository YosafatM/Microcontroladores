...
; 0000 0034 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 0035 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0036 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (1<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(255)
	OUT  0x15,R30
; 0000 0037 
...
; 0000 0089 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 008A 
; 0000 008B index = guardable;
	LDI  R26,LOW(_guardable)
	LDI  R27,HIGH(_guardable)
	RCALL __EEPROMRDB
	MOV  R5,R30
; 0000 008C 
; 0000 008D while (1)
_0x3:
; 0000 008E {
; 0000 008F actual_i = btn_incrementa;
	CLT
	SBIC 0x13,0
	SET
	BLD  R2,1
; 0000 0090 actual_g = btn_guarda;
	CLT
	SBIC 0x13,1
	SET
	BLD  R2,3
; 0000 0091 
; 0000 0092 //Boton de incremento
; 0000 0093 if (pasado_i == 1 && actual_i == 0) {
	SBRS R2,0
	RJMP _0x7
	SBRS R2,1
	RJMP _0x8
...
; 0000 0094 index++;
	INC  R5
; 0000 0095 if (index > 9) index = 0;
	LDI  R30,LOW(9)
	CP   R30,R5
	BRSH _0x9
	CLR  R5
; 0000 0096 delay_ms(40);
_0x9:
	RCALL SUBOPT_0x0
; 0000 0097 }
; 0000 0098 
; 0000 0099 if (pasado_i == 0 && actual_i == 1) {
_0x6:
	SBRC R2,0
	RJMP _0xB
	SBRC R2,1
...
; 0000 009B }
; 0000 009C 
; 0000 009D //Boton de guardado
; 0000 009E if (pasado_g == 1 && actual_g == 0) {
_0xA:
	SBRS R2,2
	RJMP _0xE
	SBRS R2,3
...
; 0000 00A1 }
; 0000 00A2 
; 0000 00A3 if (pasado_g == 0 && actual_g == 1) {
_0xD:
	SBRC R2,2
	RJMP _0x11
	SBRC R2,3
...
; 0000 00A5 }
; 0000 00A6 
; 0000 00A7 pasado_i = actual_i;
_0x10:
	BST  R2,1
	BLD  R2,0
; 0000 00A8 pasado_g = actual_g;
	BST  R2,3
	BLD  R2,2
; 0000 00A9 PORTB = tabla7segmentos[index];
	MOV  R30,R5
	LDI  R31,0
