...
; 0000 0025 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(7)
	OUT  0x1A,R30
; 0000 0026 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=1 Bit1=0 Bit0=0
; 0000 0027 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (1<<PORTA2) | (0<<PORTA1) | (0<<PORTA0);
	LDI  R30,LOW(4)
	OUT  0x1B,R30
; 0000 0028 
...
; 0000 008A tecla = 0;
	CLR  R5
; 0000 008B PORTA=0b00111110;
	LDI  R30,LOW(62)
	RCALL SUBOPT_0x0
; 0000 008C lectura=PINA&0b00111000;
; 0000 008D if (lectura==0b00110000) tecla=1;
	BRNE _0x6
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 008E if (lectura==0b00101000) tecla=4;
_0x6:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0x7
	LDI  R30,LOW(4)
	MOV  R5,R30
; 0000 008F if (lectura==0b00011000) tecla=7;
_0x7:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0x8
	...
	MOV  R5,R30
; 0000 0090 
; 0000 0091 PORTA=0b00111101;
_0x8:
	LDI  R30,LOW(61)
	RCALL SUBOPT_0x0
; 0000 0092 lectura=PINA&0b00111000;
; 0000 0093 if (lectura==0b00110000) tecla=2;
	BRNE _0x9
	LDI  R30,LOW(2)
	MOV  R5,R30
; 0000 0094 if (lectura==0b00101000) tecla=5;
_0x9:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xA
	LDI  R30,LOW(5)
	MOV  R5,R30
; 0000 0095 if (lectura==0b00011000) tecla=8;
_0xA:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xB
	...
	MOV  R5,R30
; 0000 0096 
; 0000 0097 PORTA=0b00111011;
_0xB:
	LDI  R30,LOW(59)
	RCALL SUBOPT_0x0
; 0000 0098 lectura=PINA&0b00111000;
; 0000 0099 if (lectura==0b00110000) tecla=3;
	BRNE _0xC
	LDI  R30,LOW(3)
	MOV  R5,R30
; 0000 009A if (lectura==0b00101000) tecla=6;
_0xC:
	LDI  R30,LOW(40)
	CP   R30,R4
	BRNE _0xD
	LDI  R30,LOW(6)
	MOV  R5,R30
; 0000 009B if (lectura==0b00011000) tecla=9;
_0xD:
	LDI  R30,LOW(24)
	CP   R30,R4
	BRNE _0xE
	...
	MOV  R5,R30
; 0000 009C 
; 0000 009D PORTB=tabla7segmentos [tecla];
_0xE:
	MOV  R30,R5
	LDI  R31,0
