...
_0x3:
; 0000 008E {
; 0000 008F //Revisar por los botones
; 0000 0090 if (!START_BTN) debe_avanzar = 1;
	SBIC 0x10,2
	RJMP _0x6
	SET
	BLD  R2,0
; 0000 0091 if (!STOP_BTN) debe_avanzar = 0;
_0x6:
	SBIC 0x10,1
	RJMP _0x7
	CLT
...
; 0000 0096 decena = 0;
	CLR  R4
; 0000 0097 debe_avanzar = 0;
	CLT
	BLD  R2,0
; 0000 0098 }
; 0000 0099 
; 0000 009A //Actuar según el estado
; 0000 009B if (decena == 6) debe_avanzar = 0;
_0x8:
	LDI  R30,LOW(6)
	CP   R30,R4
	BRNE _0x9
...
_0xC:
; 0000 00AA 
; 0000 00AB PORTA = mem[unidad];
_0xA:
	MOV  R30,R5
	RCALL SUBOPT_0x0
	OUT  0x1B,R0
; 0000 00AC PORTB = mem[decena];
	MOV  R30,R4
	RCALL SUBOPT_0x0
	OUT  0x18,R0
; 0000 00AD PORTC = mem[decima];
	MOV  R30,R7
	RCALL SUBOPT_0x0
	OUT  0x15,R0
